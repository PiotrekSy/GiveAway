    ...
    return (<div className="organizations" id="organizations">
        ...
        <div className="organizationsContainer">
            {type === "fundations" && <div className="organizationsItems">
                ...
                {fundationsList.length > elementsPerPage && <PaginationDigits className="pagination"
            ...
            {type === "nfo" && <div className="organizationsItems">
                ...
                {organisationsList.length > elementsPerPage && <PaginationDigits className="pagination"
                                                                                 elementsPerPage={elementsPerPage}
            ...
            {type === "local" && <div className="organizationsItems">
                ...
                {localList.length > elementsPerPage && <PaginationDigits className="pagination"
                                                                         elementsPerPage={elementsPerPage}
